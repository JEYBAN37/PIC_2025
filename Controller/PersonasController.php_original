 ...
 */
	...
	public function add2() {
		if ($this->request->is('post')) {
			...
			if ($this->Persona->save($this->request->data)) {
				...
				$this->Session->setFlash(__('El usuario no se guardo. Por favor, inténtelo de nuevo.'));
			}
		}
		//$generos = $this->Persona->Genero->find('list');
		//$preferencias = $this->Persona->Preferencia->find('list');
	...
	public function add4() {
		if ($this->request->is('post')) {
			...
			if ($this->Persona->save($this->request->data)) {
				...
				$this->Session->setFlash(__('No se ha podido guardar el registro. Por favor, Inténte nuevamente'));
			}
		}
		$generos = $this->Persona->Genero->find('list');
		$preferencias = $this->Persona->Preferencia->find('list');
	...
	public function add6() {
		if ($this->request->is('post')) {
			...
			if ($this->Persona->save($this->request->data)) {
				...
				$this->Session->setFlash(__('No se ha guardado. Por favor, nuevamente inténtelo.'));
			}
		}
		$generos = $this->Persona->Genero->find('list');
		$preferencias = $this->Persona->Preferencia->find('list');
	...
	public function add7() {
		if ($this->request->is('post')) {
			...
			if ($this->Persona->save($this->request->data)) {
				...
				$this->Session->setFlash(__('No se puede guardar. Por favor, inténtelo nuevamente.'));
			}
		}
		//$generos = $this->Persona->Genero->find('list');
		//$preferencias = $this->Persona->Preferencia->find('list');
	...
	public function add8() {
		if ($this->request->is('post')) {
			...
			if ($this->Persona->save($this->request->data)) {
				...
				$this->Session->setFlash(__('La persona no se puede guardar. Por favor, vuelva a inténtarlo.'));
			}
		}
		...
		$sectores = $this->Persona->Sector->find('list');
		$actividades = $this->Persona->Actividad->find('list');
		$this->set(compact( 'preferencias', 'etnias', 'estudios', 'poblaciones', 'ubicaciones', 'aseguradoras', 'sociedades', 'sectores', 'actividades'));
	}
	...
	public function edit2($id = null) {
		...
		if ($this->request->is(array('post', 'put'))) {
			if ($this->Persona->save($this->request->data)) {
				...
				$this->Session->setFlash(__('El usuario no fue actualizado. por favor, trate nuevamente.'));
			}
		} else {
			$options = array('conditions' => array('Persona.' . $this->Persona->primaryKey => $id));
	...
	if (!$this->Persona->exists($id)) {
		...
		$actividades = $this->Persona->Actividad->find('list');
		$actividades = $this->Persona->Actividad->find('list');
		$this->set(compact('estudios', 'poblaciones', 'ubicaciones', 'aseguradoras', 'sociedades', 'sectores', 'actividades', 'actividades'));
	}
