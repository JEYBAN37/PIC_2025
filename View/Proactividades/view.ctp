...
<div class="flex max-w-6xl mx-auto text-center mb-8 gap-4">
    <button type="button" id="btn-print"
        class="flex w-32 items-center space-x-2 bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">
    ...
    <button class="flex w-32 items-center space-x-2 bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700"
            ...
            <table class="w-full border border-gray-300 text-sm text-gray-800">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="1" class="border border-gray-300 font-semibold p-2 text-center">Fecha_actualización
                        </td>
                        <td colspan="3" class="border border-gray-300 p-2">
                    ...
                    <tr class="bg-gray-100">
                        ...
                        <td colspan="1" class="border border-gray-300 font-semibold p-2 text-center">Producto
                            relacionado:</td>
                        <td colspan="3" class="border border-gray-300 p-2">
