        ...
        <div class="form-group col-md-6">
           ...
           <?php echo $this->Form->input('poblaciones', array('label' => 'Población con la que se identifica','class' => 'form-control'));?><br> 
            ...
            <div class="form-group col-md-12">
                ...
                echo $this->Form->input('Actividad', array('label' => 'ID sistematizaciones registradas', 'type' => 'select', 'multiple' => 'checkbox', 'class' => 'checkbox-inline'));
            ...
            <div class="form-group col-md-12">
                ...
                echo $this->Form->input('Infoevento', array('label' => 'ID de Eventos o informes registrados', 'type' => 'select', 'multiple' => 'checkbox', 'class' => 'checkbox-inline'));
                ?>
            </div>
