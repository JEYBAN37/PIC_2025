...
<div class="personas form">
    ...
    <fieldset>
        <legend><?php echo __('Nuevo Registro Agente Comunitario'); ?></legend>
        <?php
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                <?php
                echo $this->Form->input('identificacion', array('label' => 'Nùmero de documento', 'class' => 'form-control'));
                ?>
            </div>
            <div class="form-group col-md-6">
                <?php
            ...
            <div class="form-group col-md-6">
                ...
                $option17 = array('' => 'Elegir', '1' => 'Urbano', '2' => 'Rural');
                echo $this->Form->input('zona', array('label' => 'Zona de residencia', 'options' => $option17, 'class' => 'form-control select-search'));
                ?>
            </div>
            <div class="form-group col-md-6">
                <?php
