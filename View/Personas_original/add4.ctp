...
<?php echo $this->Form->create('Persona'); ?>
	<fieldset>
		<legend><?php echo __('Nuevo Registro Persona Publica o Social'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Nueva Actividad'), array('controller' => 'actividades', 'action' => 'add')); ?> <
