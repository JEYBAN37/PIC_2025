...
<div class="flex max-w-6xl mx-auto text-center mb-8 gap-4">
    ...
    <button title="Ir a su sistematización"
        class="flex items-center space-x-2 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700"
        onclick="window.location.href='<?php echo $this->Html->url(array('controller' => 'proactividades', 'action' => 'view',  $procesoregistro['Procesoregistro']['proactividad_id'])); ?>'">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            class="lucide lucide-square-pen-icon lucide-square-pen">
    ...
    <button title="editar encuentro"
        class="flex items-center space-x-2 bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700"
        onclick="window.location.href='<?php echo $this->Html->url(array('action' => 'edit',  $procesoregistro['Procesoregistro']['id'])); ?>'">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            class="lucide lucide-square-pen-icon lucide-square-pen">
                ...
                <tbody>
                    ...
                    <tr class="bg-gray-100">
                        ...
                        <td colspan="4" class="border border-gray-300 p-2">
                            <?php echo $this->Html->link($procesoregistro['Proactividad']['id'], array('controller' => 'proactividades', 'action' => 'view', $procesoregistro['Proactividad']['id'])); ?>
                        </td>
                    </tr>

                    <tr>
                        <td colspan="1" class="border border-gray-300 font-semibold p-2 text-center">Objetivo
                            Sistematización</td>
                    ...
                    <tr>
                        <td colspan="1" class="border border-gray-300 font-semibold p-2 text-center">Tema tratado en la
                            sesión</td>
                        <td colspan="8" class="border border-gray-300 p-2">
                    ...
                    <!--tr>
                        <td class="border border-gray-300 font-semibold p-2 text-center">Evidencias Fotograficas
                        </td>
                        <td colspan="8" class="border border-gray-300 p-2">
                            <div class="mt-10 pt-10 border-t border-gray-200 no-print">
                                <h3 class="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-2">
                                    ...
                                    Evidencias Fotográficas del Encuentro (Soporte Digital)
                                </h3>

                                <?php if (!empty($adjuntosZip['images'])): ?>
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <?php foreach ($adjuntosZip['images'] as $imgUrl): ?>
                                    <div
                                        class="border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition bg-gray-50 flex items-center justify-center">
                                        <img src="<?php echo $imgUrl; ?>" class="w-full h-48 object-cover object-center"
                                            alt="Evidencia PIC">
                                    </div>
                                    <?php endforeach; ?>
                                </div>
                                ...
                                <div class="p-6 bg-gray-50 rounded-xl border border-dashed border-gray-300 text-center">
                                    <p class="text-sm text-gray-500 font-medium">No se encontraron imágenes o
                                        evidencias
                                        fotográficas dentro del archivo comprimido registrado.</p>
                                </div>
                                <?php endif; ?>

                                <?php if (!empty($adjuntosZip['otherFiles'])): ?>
                                <div class="mt-6 pt-6 border-t border-gray-100">
                                    <h4 class="text-sm font-semibold text-gray-700 mb-3">Otros Documentos Adjuntos
                                        Detectados:</h4>
                                    <div class="flex flex-wrap gap-2">
                                        <?php foreach ($adjuntosZip['otherFiles'] as $docPath): ?>
                                        <a href="<?php echo $this->webroot . 'files/tmp/' . $this->Session->id() . '/' . $docPath; ?>"
                                            target="_blank"
                                            class="text-xs inline-flex items-center gap-1.5 bg-blue-50 text-blue-700 px-3 py-2 rounded-lg hover:bg-blue-100 font-medium transition">
