        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="col-span-2 text-md font-semibold my-6">
                <div class="flex items-center mb-4">
                    ...
                    <label for="proactividad_id" class="font-semibold">Tipo de poblacion participante</label>
                    <p class="text-red-600">*</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="col-span-2 text-md font-semibold my-6">
                ...
                <div class="relative w-full mt-4">
                    <?php if (!empty($this->request->data['Procesoregistro']['anexo'])): ?>
                        <div class="block w-full text-sm text-gray-700 border border-gray-300 rounded-lg cursor-pointer bg-white focus:outline-none focus:ring-2 focus:ring-blue-400 p-3 file:mr-4 file:py-6 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                            Archivo actual:
                            <a href="<?php echo $this->webroot . 'files/procesoregistro/anexo/' . $this->request->data['Procesoregistro']['sisproceso_dir'] . '/' . $this->request->data['Procesoregistro']['anexo']; ?>" target="_blank" class="text-blue-600 underline ml-2">
                                <?php echo $this->request->data['Procesoregistro']['anexo']; ?>
                            </a>
                        </div>
                    <?php endif; ?>
                </div>
