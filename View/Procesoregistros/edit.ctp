             ...
             <div class="panel panel-default">
                 ...
                 <fieldset>
                     ...
                     <div class="row">
                         ...
                         <div class="panel panel-default form-group col-md-12">
                             <p class="help-block">Asociar plan de sesión</p>
                             <div class="row ">
                         ...
                         <div class="form-group col-md-6">
                             <?php echo $this->Form->submit('Actualizar', array('name' => 'btn')); ?>
                         </div>
 ...
 <script type="text/javascript">
     ...
     function agregarOpcionSeleccion() {
         $("#ProcesoregistroUbicacionId").prepend();
         $("#ProcesoregistroProactividadId").prepend();
         $("#ProcesoregistroPlsesionId").prepend();
