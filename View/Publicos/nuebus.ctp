...
<?php
echo $this->Form->create("Publico", array("action" => "nuebus"));
...
<table cellpadding="0" cellspacing="0">
	...
	foreach($l as $i => $v){
		echo "<tr>";
		foreach($v["Publico"] as $j => $w){
			echo "<td>".$w."</td>";
		}
		
		echo "<td>".$this->Html->link("Ver", "view/".$v["Publico"]["id"])."</td>";	
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Actualizar'), array('controller' => 'publicos', 'action' => 'nuebus')); ?> </li>			
