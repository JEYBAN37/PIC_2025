<div class="actividadesViewTests form">
<?php echo $this->Form->create('ActividadesViewTest'); ?>
	<fieldset>
		<legend><?php echo __('Edit Actividades View Test'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ActividadesViewTest.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('ActividadesViewTest.id'))); ?></li>
