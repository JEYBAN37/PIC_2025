...
<h3><a ><img src="../../img/logoescudopasto.jpg" width="40" height="auto" ></a> Plan de Salud Publica de Intervenciones Colectivas </h3>
									...
									<tbody>
										...
										<?php foreach ($productos as $producto) : ?>
											<tr class="gradeA odd" >
												...
												<td><?php echo ($producto['Producto']['nombredim']); ?></td>
												...
												<!--td>
													<div>
														<p>
															<span class="pull-right text-muted"><?php echo ($producto['Producto']['porcentajeavance']); ?>%</span>
														</p>
														<div class="progress progress-striped active">
															<div class="progress-bar  progress-bar-success" role="progressbar" aria-valuenow="<?php echo ($producto['Producto']['porcentajeavance']); ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo ($producto['Producto']['porcentajeavance']); ?>%">
																<span class="sr-only"><?php echo ($producto['Producto']['porcentajeavance']); ?></span>
															</div>
														</div>
													</div>
												</td>
												<td>
													<div>
														<p>
															<span class="pull-right text-muted"><?php echo ($producto['Producto']['porcentajeseptiembre']); ?>%</span>
														</p>
														<div class="progress progress-striped active">
															<div class="progress-bar  progress-bar-success" role="progressbar" aria-valuenow="<?php echo ($producto['Producto']['porcentajeseptiembre']); ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo ($producto['Producto']['porcentajeseptiembre']); ?>%">
																<span class="sr-only"><?php echo ($producto['Producto']['porcentajeseptiembre']); ?></span>
															</div>
														</div>
													</div>
												</td>
												...
												<td>
													<div>
														<p>
															<span class="pull-right text-muted"><?php echo ($producto['Producto']['porcentajeoctubre']); ?>%</span>
														</p>
														<div class="progress progress-striped active">
															<div class="progress-bar  progress-bar-success" role="progressbar" aria-valuenow="<?php echo ($producto['Producto']['porcentajeoctubre']); ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo ($producto['Producto']['porcentajeoctubre']); ?>%">
																<span class="sr-only"><?php echo ($producto['Producto']['porcentajeoctubre']); ?></span>
															</div>
														</div>
													</div>
												</td-->
