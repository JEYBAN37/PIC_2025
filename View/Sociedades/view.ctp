...
<h2><?php echo __('Sociedad'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($sociedad['Sociedad']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Tiposociedad'); ?></dt>
		<dd>
			<?php echo h($sociedad['Sociedad']['tiposociedad']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Caracteristica'); ?></dt>
		<dd>
			<?php echo h($sociedad['Sociedad']['caracteristica']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Sociedad'), array('action' => 'edit', $sociedad['Sociedad']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Sociedad'), array('action' => 'delete', $sociedad['Sociedad']['id']), array(), __('Are you sure you want to delete # %s?', $sociedad['Sociedad']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Sociedades'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Sociedad'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($sociedad['Organizacion'])): ?>
	...
	<?php foreach ($sociedad['Organizacion'] as $organizacion): ?>
		<tr>
...
<div class="related">
	...
	<?php foreach ($sociedad['Persona'] as $persona): ?>
		<tr>
