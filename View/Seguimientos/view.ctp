...
<div class="max-w-6xl mx-auto p-18">
    <div class="bg-white shadow-2xl rounded-xl p-12 block mb-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <!-- Objetivo General -->
            <div
                class="col-span-1 col-span-2 md:col-span-1 text-md font-semibold my-4 mr-4 rounded-lg border  border-gray-300 p-4">
                <div class="w-full flex items-center justify-center mb-2">
                    <label for="objactividad" class="mr-2 font-semibold text-gray-800 text-center text-md">Porcentaje
                        reportado</label>
                </div>
                <div class="w-full background-white flex items-center justify-center">
                    ...
                    <svg width="150" height="150" viewBox="0 0 48 48">
                        ...
                        <circle cx="24" cy="24" r="20" stroke="#2563eb" stroke-width="6" fill="none"
                            stroke-dasharray="<?php echo 2 * pi() * 20; ?>" stroke-dashoffset="<?php
                        ...
                        <text x="25" y="27" text-anchor="middle" fill="#9b9b9bff" font-size="8" font-weight="bold"
                            id="porcentaje-texto">
                            <?php echo $percent . '%'; ?>
                        </text>
                    </svg>
            ...
            <div
                class="col-span-1 col-span-2 md:col-span-1 text-md font-semibold my-4 rounded-lg border  border-gray-300 p-4">
                <div class="w-full flex items-center justify-center mb-2">
                    <label for="objactividad" class="mr-2 font-semibold text-gray-800 text-center text-md">Avance de
                        actividad</label>
                </div>
                <div class="w-full background-white flex items-center justify-center">
                    <!-- Barra circular de progreso -->
                    <svg width="150" height="150" viewBox="0 0 48 48">
                        <circle cx="24" cy="24" r="20" stroke="#e5e7eb" stroke-width="6" fill="none" />
                        <circle cx="24" cy="24" r="20" stroke="#43A047" stroke-width="6" fill="none"
                            stroke-dasharray="<?php echo 2 * pi() * 20; ?>" stroke-dashoffset="<?php
...
<div class="flex max-w-6xl mx-auto text-center mb-8 gap-4">
    ...
    <button title="Editar Reporte" type="button" id="btn-hide"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            onclick="window.location.href='<?php echo $this->Html->url(array('controller'=>'Seguimientos','action' => 'editpic/'. $seguimiento['Seguimiento']['id'])); ?>'">
            <path d="M16 5H3" />
            <path d="M16 12H3" />
            <path d="M11 19H3" />
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="8" class="border border-gray-300 font-semibold text-center p-2">
                            NOMBRE DEL FORMATO: <br>Reporte al cumplimiento de actividades (PIC) del Sistema de
                            información Ciudad Bienestar</br>
                        </td>
                    </tr>
                    ...
                    <tr class="bg-gray-100">
                        <th colspan="9" class="border border-gray-300 text-center font-bold p-2 uppercase">
                            <?php echo __('Producto Anexo Tecnico 2026'); ?></th>
                    </tr>
                    <tr>
                        <td colspan="1" class="border border-gray-300 font-semibold p-2 text-center">
                            <?php echo __('Responsable'); ?></td>
                        <td colspan="3" class="border border-gray-300 p-2 lowercase">
                            <?php echo h($seguimiento['Responsable']['nombres']); ?> </td>
                        <td colspan="2" class="border border-gray-300 font-semibold p-2 text-center ">
                            <?php echo __('Referente SMS'); ?></td>
                        <td colspan="3" class="border border-gray-300 p-2 lowercase">
                            <?php echo h($seguimiento['Referente']['nombres']); ?> </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="border border-gray-300 p-2">
                            <?php echo $this->Time->format('d-m-Y h:i A', ($seguimiento['Seguimiento']['created'])); ?>
                        </td>
                        ...
                        <td colspan="3" class="border border-gray-300 p-2">
                            <?php echo $this->Time->format('d-m-Y h:i A', ($seguimiento['Seguimiento']['update_date'])); ?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="1" class="border border-gray-300 font-semibold p-2 bg-gray-100">Proyecto
                            relacionado</td>
                        <td colspan="3" class="border border-gray-300 p-2">
                            <?php echo ($seguimiento['Producto']['nombredim']); ?>
                        </td>
                        <td colspan="1" class="border border-gray-300 font-semibold p-2 bg-gray-100">Presupuesto
                            actividad</td>
                    ...
                    <tr>
                        <td colspan="1" class="border border-gray-300 font-semibold p-2 bg-gray-100">Eje Estratégico
                        </td>
                        <td colspan="3" class="border border-gray-300 p-2">
                            <?php echo ($seguimiento['Producto']['ejeEstrategico']); ?>
                        </td>

                        <td colspan="1" class="border border-gray-300 font-semibold p-2 bg-gray-100">Linea Operativa
                        </td>
                        <td colspan="4" class="border border-gray-300 font-semibold p-2">
                            <?php echo ($seguimiento['Producto']['lineaOperativa']); ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="1" class="border border-gray-300 font-semibold p-2 bg-gray-100">Unidad de Medida
                        </td>
                        <td colspan="4" class="border border-gray-300 font-semibold p-2">
                    ...
                    <tr class="bg-gray-100">
                        ...
                        <td colspan="3" class="border border-gray-300 p-2">
                            <?php echo $seguimiento['Producto']['poblacion']; ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="border border-gray-300 p-2">
                            <?php echo $seguimiento['Seguimiento']['valorejecutado']; ?>%
                        </td>
                    ...
                    <tr>
                        <td colspan="1" class="border border-gray-300 font-semibold p-2 text-center">Evidencia requerida
                        </td>
                        <td colspan="8" class="border border-gray-300 p-2">
                    ...
                    <tr>
                        <td colspan="1" class="border border-gray-300 font-semibold p-2 text-center">Observación PIC
                        </td>
                        <td colspan="8" class="border border-gray-300 p-2">
                    ...
                    <tr>
                        <td colspan="1" class="border border-gray-300 font-semibold p-2 text-center">Observación SMS
                        </td>
                        <td colspan="8" class="border border-gray-300 p-2">
                    ...
                    <tr>
                        ...
                        <td colspan="2"
                            class="border border-gray-300 p-2 text-blue-600 hover:underline break-words max-w-xs"
                            style="word-break: break-all;">
                            <?php echo $this->Html->link('../files/seguimiento/productoanexo/' . $seguimiento['Seguimiento']['dirproductoanexo'] . '/' . $seguimiento['Seguimiento']['productoanexo']); ?>

                            <a href="<?php echo $this->webroot . 'files/seguimiento/productoanexo/' . $seguimiento['Seguimiento']['dirproductoanexo'] . '/' . $seguimiento['Seguimiento']['dirproductoanexo']; ?>"
                                target="_blank" class="text-blue-600 underline ml-2">
                                <?php echo $seguimiento['Seguimiento']['dirproductoanexo']; ?>
                            </a>
...
function imprimirContenido(e, printContents) {
    ...
    w.document.write('<div style="width:100vw;max-width:100%;box-sizing:border-box;">' + printContents.innerHTML +
        '</div>');
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var porcentaje =
        <?php echo isset($seguimiento['Producto']['porcentajeavancetotal']) && is_numeric($seguimiento['Producto']['porcentajeavancetotal']) ? $seguimiento['Producto']['porcentajeavancetotal'] : 0; ?>;
    var porcentajeavance =
        <?php echo isset($seguimiento['Producto']['porcentajeavance1']) && is_numeric($seguimiento['Producto']['porcentajeavance1']) ? $seguimiento['Producto']['porcentajeavance1'] : 0; ?>;
