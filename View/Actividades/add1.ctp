    ...
    <fieldset>
        ...
        <div class="row">
           ...
           <p>  <?php echo 'Copie de esta lista a la casilla siguiente las poblaciones participantes o escriba otras que no esten categorizadas.'?></p> 
            ...
            <div class="form-group col-md-12">
                <?php
                echo('NOTA: Hacer uso de los instrumentos de caracterización de organizaciones o instituciones para registrar más información.');

                echo $this->Form->input('anexo', array('label' => '25 °Soportes', 'type' => 'file' , 'class' => 'form-control', 'onchange'=>'validarTamanioSoporte()'));
                ...
                echo $this->Form->input('diract', array('type' => 'hidden'));
...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Html->link(__('Lista Actividades'), array('controller' => 'actividadesviewtests', 'action' => 'nuebus')); ?></li>			 
...
<script type="text/javascript">
    ...
    function validarTamanioSoporte(){
     ...
     function agregarOpcionSeleccion(){
        $("#ActividadUbicacionId").prepend("<option value='' selected='selected'>Seleccione</option>");
        $("#ActividadProductoId").prepend("<option value='' selected='selected'>Seleccione</option>");
        $("#ActividadResponsableId").prepend("<option value='' selected='selected'>Seleccione</option>");
    }
