...
<?php echo json_encode($actividad); ?>
    <table class="table-hover table-striped table-bordered">
        ...
        <tr>
            ...
            <td colspan="2"><?php echo h($actividad['Actividad']['producto1']); ?></td>
        </tr>  
        <tr>
        ...
        <tr>
            <td>Lugar</td>
            <td><?php echo h($actividad['Ubicacion']['barrio']); ?></td>
            <td><?php echo h($actividad['Ubicacion']['comuna']); ?></td>
    ...
    <table class="table-hover table-striped table-bordered">
        <tr>
         ...
         <tr>
            ...
            <td colspan="6">
               ...
               <?php echo $this->Html->link($actividad['Actividad']['plan']); ?></td><td><?php echo __('Plan sesion'); ?>
        ...
        <tr>
            <td><?php echo __('RESPONSABLE DEL ACTA'); ?></td>
            <td ><?php echo h($actividad['Responsable']['nombres']); ?>  </td>
            <td ><?php echo h($actividad['Responsable']['profesion']); ?>  </td>
        </tr>

        <tr>
            <td><?php echo __('Responsable de elaboración del acta:'); ?></td>
            <td ><?php echo h($acta['Responsable']['nombres']); ?>  </td>
            <td>Dimensión:<?php echo h($acta['Producto']['dimensiones']); ?></td>
            <td>Producto:<?php echo h($acta['Producto']['activity']); ?></td>
            <td>Entorno:<?php echo h($acta['Producto']['entorno']); ?></td>


        </tr>
        <tr>
             <td colspan="6">Tarea:<?php echo h($acta['Producto']['tarea']); ?></td >
        </tr> 
