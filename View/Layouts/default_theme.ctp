                            ...
                            <a href="#">
                                <div>
                                   <i><img src="../img/flecha.png" alt="Imagen de marcador genérico" width="10px" height="10px"></i>  Primer Cohorte
                                    <span class="pull-right text-muted small">30 Junio 2021</span>
                                </div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <span class="pull-right text-muted small">30 Agosto 2021</span>
                                </div>
                            </a>
                        </li>
                        <li class="divider"></li>
                            ...
                            <a href="#">
                                <div>
                                   <i><img src="../img/flecha.png" alt="Imagen de marcador genérico" width="10px" height="10px"></i>  Monitoreo ejecucion PIC
                                    <span class="pull-right text-muted small">10 julio 2021</span>
                                </div>
                            </a>
                        </li>
...
<footer class="footer">
                    ...
                    <div class="col-md-12 text-center">
                        <br>
                        <div class="copyright">&copy; Gestión de la Salud Publica. Versión 4.0 - 2021 <a href="https://www.saludpasto.gov.co/">Secretaria Municipal de Salud</a>.</div>
                    </div>
