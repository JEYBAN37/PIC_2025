...
<h2><?php echo __('Genero'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($genero['Genero']['genero']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Caracteristica'); ?></dt>
		<dd>
			<?php echo h($genero['Genero']['caracteristica']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<tr>
		...
		<th><?php echo __('Preferencia'); ?></th>
		<th><?php echo __('Etnia'); ?></th>
	...
	<?php foreach ($genero['Persona'] as $persona): ?>
		<tr>
			...
			<td><?php echo $persona['preferencia']; ?></td>
			<td><?php echo $persona['etnia']; ?></td>
			...
			<td><?php echo $persona['telefonoacudiente']; ?></td>
			<td><?php echo $persona['actividad_id']; ?></td>
			<td><?php echo $persona['fecharegistro']; ?></td>
			<td><?php echo $persona['actualizado']; ?></td>
			<td><?php echo $persona['equipo']; ?></td>
			<td><?php echo $persona['parentescosisben']; ?></td>
			<td class="actions">
