...
<?php echo $this->Form->create('Participantesevento'); ?>
	<fieldset>
		<legend><?php echo __('Edit Participantesevento'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Participantesevento.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Participantesevento.id'))); ?></li>
