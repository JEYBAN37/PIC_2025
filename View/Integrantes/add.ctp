...
<?php echo $this->Form->create('Integrante'); ?>
	<fieldset>
		<legend><?php echo __('Informacion general'); ?></legend>
	<?php
		...
		echo ('Registre su experiencia en la estrategia');
...
<!--div class="actions">
	...
	<!ul>
	    ...
	    <li><?php echo $this->Html->link(__('aumentar datos'), array('controller' => 'responsables', 'action' => 'add')); ?> </li>	
