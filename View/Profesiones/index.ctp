...
<div class="profesiones index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('perfilprofesion'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($profesion['Profesion']['perfilprofesion']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $profesion['Profesion']['id']), array(), __('Are you sure you want to delete # %s?', $profesion['Profesion']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Nueva Profesion'), array('action' => 'add')); ?></li>
