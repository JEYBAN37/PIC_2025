    ...
    <table id="miTabla" style="width:100%;" class="stripe hover text-sm text-left text-gray-600 border border-gray-200 rounded-lg overflow-hidden">
        <thead class="bg-gray-200 font-medium border-b border-gray-300">
            <tr class=" text-gray-900 font-light">
                ...
                <th class="px-2 py-2 font-semibold text-center cursor-pointer hover:bg-green-100">Tipo Poblacion</th>
                <th class="px-2 py-2 font-semibold text-center cursor-pointer hover:bg-green-100">Dimension</th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const table = $miTabla.DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "/PIC/plsesiones/getPlsesiones",
                columns: [
                    // Columna control (+)
                    {
                        data: null,
