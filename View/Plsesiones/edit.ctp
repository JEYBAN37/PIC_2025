                ...
                <div class="flex space-x-4 items-center">
                    ...
                    <div>
                        <input type="radio"
                            ...
                            data-show="false"
                            <?php echo (isset($this->request->data['Plsesion']['cuerpoterritorio']) && $this->request->data['Plsesion']['cuerpoterritorio'] == '0') ? 'checked' : ''; ?> /> <!-- 👈 Por defecto NO -->
                ...
                <div class="flex space-x-4 items-center">
                    ...
                    <div>
                        <input type="radio"
                            ...
                            data-show="false"
                            <?php echo (isset($this->request->data['Plsesion']['territorial']) && $this->request->data['Plsesion']['territorial'] == 0) ? 'checked' : ''; ?> /> <!-- 👈 Por defecto NO -->
                ...
                <div class="flex space-x-4 items-center">
                    ...
                    <div>
                        <input type="radio"
                            ...
                            data-show="false"
                            class="hidden peer"
                            <?php echo (isset($this->request->data['Plsesion']['poblacional']) && $this->request->data['Plsesion']['poblacional'] == 0) ? 'checked' : ''; ?> /> <!-- 👈 Por defecto NO -->
                ...
                <div class="flex space-x-4 items-center">
                    ...
                    <div>
                        <input type="radio"
                            ...
                            data-show="false"
                            class="hidden peer"
                            <?php echo (isset($this->request->data['Plsesion']['interultural']) && $this->request->data['Plsesion']['interultural'] == 0) ? 'checked' : ''; ?> /> <!-- 👈 Por defecto NO -->
                ...
                <div class="flex space-x-4 items-center">
                    ...
                    <div>
                        <input type="radio"
                            ...
                            data-show="false"
                            class="hidden peer"
                            <?php echo (isset($this->request->data['Plsesion']['diferencial']) && $this->request->data['Plsesion']['diferencial'] == 0) ? 'checked' : ''; ?> /> <!-- 👈 Por defecto NO -->
                        ...
                        <div class="flex space-x-4 items-center">
                            ...
                            <div>
                                <input type="radio"
                                    ...
                                    data-show="false"
                                    class="hidden peer"
                                    <?php echo (isset($this->request->data['Plsesion']['obj_organizaciones']) && $this->request->data['Plsesion']['obj_organizaciones'] == 0) ? 'checked' : ''; ?> /> <!-- 👈 Por defecto NO -->
                        ...
                        <div class="flex space-x-4">
                            ...
                            <div>
                                <input type="radio"
                                    ...
                                    data-show="false"
                                    class="hidden peer"
                                    <?php echo (isset($this->request->data['Plsesion']['obj_instituciones']) && $this->request->data['Plsesion']['obj_instituciones'] == 0) ? 'checked' : ''; ?> /> <!-- 👈 Por defecto NO -->
                ...
                <div class="relative w-full mt-4">
                    <?php if (!empty($this->request->data['Plsesion']['anexo'])): ?>
                        <div class="block w-full text-sm text-gray-700 border border-gray-300 rounded-lg cursor-pointer bg-white focus:outline-none focus:ring-2 focus:ring-blue-400 p-3 file:mr-4 file:py-6 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                            Archivo actual:
                            <a href="<?php echo $this->webroot . 'files/plsesion/anexo/' . $this->request->data['Plsesion']['dirplanes'] . '/' . $this->request->data['Plsesion']['anexo']; ?>" target="_blank" class="text-blue-600 underline ml-2">
