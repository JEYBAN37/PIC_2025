...
if (!empty($this->request->data['Plsesion']['sesion'])) {
    if (strpos($this->request->data['Plsesion']['sesion'], ' / ') !== false) {
        list($num, $total) = explode(' / ', $this->request->data['Plsesion']['sesion']);
    } else {
        $num = $this->request->data['Plsesion']['sesion'];
        $total = '';
    }
    $numero = $num;
    $totalN  = $total;
...
<div class="max-w-5xl mx-auto text-center mb-8">
    <h1 class="text-5xl font-bold mb-4 text-blue-600">
        Editar Plan de Sesión
    </h1>
    <p class="text-gray-500 mb-4 text-lg">
        Edite los datos del plan de sesión.
    </p>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="col-span-2 text-md font-semibold mb-6">
                ...
                <div class="flex gap-2 items-center">
                    <input type="text" id="sesion_numero" name="sesion_numero" value="<?= $numero ?>" min="1" max="12"
                        ...
                        placeholder="Sesión a realizar N°" required />
                    <span class="mx-2">de</span>
                    <input type="text" id="sesion_total" name="sesion_total" value="<?= $totalN ?>" min="1" max="12"
                        class="text-center border border-gray-300 rounded-lg w-64 p-2 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-sm text-gray-700"
                        placeholder="Total de sesiones" required />
                </div>
    ...
    <div class="bg-white shadow-2xl rounded-xl p-12">
        ...
        <div class="flex items-center mb-4">
            ...
            <div class="ml-4">
                ...
                <p class="text-gray-500">Cual es la intención del equipo con esta actividad, El espíritu de la práctica
                    pedagógica.</p>
            </div>
    ...
    <div class="bg-white shadow-2xl rounded-xl p-12">
        ...
        <div class="flex items-center mb-4">
            ...
            <div class="ml-4">
                ...
                <p class="text-gray-500">Marque con una X la casilla según corresponda. Establecen un norte de los
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 mx-16 md:mx-10 lg:mx-14">
            ...
            <div class="flex justify-between col-span-2 text-md font-semibold m-6">
                ...
                <div class="flex space-x-4 items-center">
                    <!-- Botón NO -->
                    <div>
                        <input type="radio" name="data[Plsesion][cuerpoterritorio]" id="cuerpoterritorio-no" value="0"
                            class="hidden peer" data-target="cuerpoterritorio" data-show="false"
                            <?php echo (isset($this->request->data['Plsesion']['cuerpoterritorio']) && $this->request->data['Plsesion']['cuerpoterritorio'] == '0') ? 'checked' : ''; ?> />
                        <!-- 👈 Por defecto NO -->
                        <label for="cuerpoterritorio-no" class="px-12 py-2 rounded-lg border cursor-pointer hover:text-white hover:bg-blue-600
                    ...
                    <!-- Botón SÍ -->
                    <div>
                        <input type="radio" name="data[Plsesion][cuerpoterritorio]" id="cuerpoterritorio-si" value="1"
                            data-target="cuerpoterritorio" data-show="true" class="hidden peer cursor-pointer"
                            <?php echo (isset($this->request->data['Plsesion']['cuerpoterritorio']) && $this->request->data['Plsesion']['cuerpoterritorio'] == '1') ? 'checked' : ''; ?> />
                        <label for="cuerpoterritorio-si" class="px-12 py-2 rounded-lg border hover:bg-blue-600 cursor-pointer hover:text-white
                       peer-checked:bg-blue-600 peer-checked:text-white">
                            X
                        </label>
                    </div>
            ...
            <div class="flex justify-between col-span-2 text-md font-semibold mb-6 mx-6">
                ...
                <div class="flex space-x-4 items-center">
                    <!-- Botón NO -->
                    <div>
                        <input type="radio" name="data[Plsesion][part_significativa]" id="part_significativa-no"
                            value="0" data-target="part_significativa" data-show="false" class="hidden peer"
                            <?php echo (isset($this->request->data['Plsesion']['part_significativa']) && $this->request->data['Plsesion']['part_significativa'] == 0) ? 'checked' : ''; ?> />
                        <label for="part_significativa-no" class="px-12 py-2 rounded-lg border cursor-pointer hover:text-white hover:bg-blue-600
                       peer-checked:bg-blue-600 peer-checked:text-white">
                            -
                        </label>
                    </div>
                    ...
                    <!-- Botón SÍ -->
                    <div>
                        <input type="radio" name="data[Plsesion][part_significativa]" id="part_significativa-si"
                            value="1" data-target="part_significativa" data-show="true"
                            class="hidden peer cursor-pointer"
                            <?php echo (isset($this->request->data['Plsesion']['part_significativa']) && $this->request->data['Plsesion']['part_significativa'] == 1) ? 'checked' : ''; ?> />
                        <label for="part_significativa-si" class="px-12 py-2 rounded-lg border hover:bg-blue-600 cursor-pointer hover:text-white
                       peer-checked:bg-blue-600 peer-checked:text-white">
                            X
                        </label>
                    </div>
            ...
            <div class="flex justify-between col-span-2 text-md font-semibold mb-6 mx-6">
                ...
                <div class="flex space-x-4 items-center">
                    <!-- Botón NO -->
                    <div>
                        <input type="radio" name="data[Plsesion][ciudadaniaactiva]" id="ciudadaniaactiva-no"
                            data-target="ciudadaniaactiva" data-show="false" value="0" class="hidden peer"
                            <?php echo (isset($this->request->data['Plsesion']['ciudadaniaactiva']) && $this->request->data['Plsesion']['ciudadaniaactiva'] == 0) ? 'checked' : ''; ?> />
                        <label for="ciudadaniaactiva-no" class="px-12 py-2 rounded-lg border cursor-pointer hover:text-white hover:bg-blue-600
                       peer-checked:bg-blue-600 peer-checked:text-white">
                            -
                        </label>
                    </div>
                    <!-- Botón SÍ -->
                    <div>
                        <input type="radio" name="data[Plsesion][ciudadaniaactiva]" id="ciudadaniaactiva-si" value="1"
                            data-target="ciudadaniaactiva" data-show="true" class="hidden peer cursor-pointer"
                            <?php echo (isset($this->request->data['Plsesion']['ciudadaniaactiva']) && $this->request->data['Plsesion']['ciudadaniaactiva'] == 1) ? 'checked' : ''; ?> />
                        <label for="ciudadaniaactiva-si" class="px-12 py-2 rounded-lg border hover:bg-blue-600 cursor-pointer hover:text-white
                       peer-checked:bg-blue-600 peer-checked:text-white">
                            X
                        </label>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 mx-16 md:mx-10 lg:mx-14">
            ...
            <div class="flex justify-between col-span-2 text-md font-semibold m-6">
                ...
                <div class="flex space-x-4 items-center">
                    <!-- Botón NO -->
                    <div>
                        <input type="radio" name="data[Plsesion][territorial]" id="territorial-no" value="0"
                            class="hidden peer" data-target="territorial" data-show="false"
                            <?php echo (isset($this->request->data['Plsesion']['territorial']) && $this->request->data['Plsesion']['territorial'] == 0) ? 'checked' : ''; ?> />
                        <!-- 👈 Por defecto NO -->
                        <label for="territorial-no" class="px-12 py-2 rounded-lg border cursor-pointer hover:text-white hover:bg-blue-600
                       peer-checked:bg-blue-600 peer-checked:text-white">
                            -
                        </label>
                    </div>
                    ...
                    <!-- Botón SÍ -->
                    <div>
                        <input type="radio" name="data[Plsesion][territorial]" id="territorial-si" value="1"
                            data-target="territorial" data-show="true" class="hidden peer cursor-pointer"
                            <?php echo (isset($this->request->data['Plsesion']['territorial']) && $this->request->data['Plsesion']['territorial'] == 1) ? 'checked' : ''; ?> />
                        <label for="territorial-si" class="px-12 py-2 rounded-lg border hover:bg-blue-600 cursor-pointer hover:text-white
                       peer-checked:bg-blue-600 peer-checked:text-white">
                            X
                        </label>
                    </div>
            ...
            <div class="flex justify-between col-span-2 text-md font-semibold mb-6 mx-6">
                ...
                <div class="flex space-x-4 items-center">
                    <!-- Botón NO -->
                    <div>
                        <input type="radio" name="data[Plsesion][poblacional]" id="poblacional-no" value="0"
                            data-target="poblacional" data-show="false" class="hidden peer"
                            <?php echo (isset($this->request->data['Plsesion']['poblacional']) && $this->request->data['Plsesion']['poblacional'] == 0) ? 'checked' : ''; ?> />
                        <!-- 👈 Por defecto NO -->
                        <label for="poblacional-no" class="px-12 py-2 rounded-lg border cursor-pointer hover:text-white hover:bg-blue-600
                       peer-checked:bg-blue-600 peer-checked:text-white">
                            -
                        </label>
                    </div>
                    ...
                    <!-- Botón SÍ -->
                    <div>
                        <input type="radio" name="data[Plsesion][poblacional]" id="poblacional-si" value="1"
                            data-target="poblacional" data-show="true" class="hidden peer cursor-pointer"
                            <?php echo (isset($this->request->data['Plsesion']['poblacional']) && $this->request->data['Plsesion']['poblacional'] == 1) ? 'checked' : ''; ?> />
                        <label for="poblacional-si" class="px-12 py-2 rounded-lg border hover:bg-blue-600 cursor-pointer hover:text-white
                       peer-checked:bg-blue-600 peer-checked:text-white">
                            X
                        </label>
                    </div>
            ...
            <div class="flex justify-between col-span-2 text-md font-semibold mb-6 mx-6">
                ...
                <div class="flex space-x-4 items-center">
                    <!-- Botón NO -->
                    <div>
                        <input type="radio" name="data[Plsesion][interultural]" id="interultural-no" value="0"
                            data-target="intercultural" data-show="false" class="hidden peer"
                            <?php echo (isset($this->request->data['Plsesion']['interultural']) && $this->request->data['Plsesion']['interultural'] == 0) ? 'checked' : ''; ?> />
                        <!-- 👈 Por defecto NO -->
                        <label for="interultural-no" class="px-12 py-2 rounded-lg border cursor-pointer hover:text-white hover:bg-blue-600
                       peer-checked:bg-blue-600 peer-checked:text-white">
                            -
                        </label>
                    </div>
                    ...
                    <!-- Botón SÍ -->
                    <div>
                        <input type="radio" name="data[Plsesion][interultural]" id="interultural-si" value="1"
                            data-target="intercultural" data-show="true" class="hidden peer cursor-pointer"
                            <?php echo (isset($this->request->data['Plsesion']['interultural']) && $this->request->data['Plsesion']['interultural'] == 1) ? 'checked' : ''; ?> />
                        <label for="interultural-si" class="px-12 py-2 rounded-lg border hover:bg-blue-600 cursor-pointer hover:text-white
                       peer-checked:bg-blue-600 peer-checked:text-white">
                            X
                        </label>
                    </div>
            ...
            <div class="flex justify-between col-span-2 text-md font-semibold mb-6 mx-6">
                ...
                <div class="flex space-x-4 items-center">
                    <!-- Botón NO -->
                    <div>
                        <input type="radio" name="data[Plsesion][diferencial]" id="diferencial-no" value="0"
                            data-target="diferencial" data-show="false" class="hidden peer"
                            <?php echo (isset($this->request->data['Plsesion']['diferencial']) && $this->request->data['Plsesion']['diferencial'] == 0) ? 'checked' : ''; ?> />
                        <!-- 👈 Por defecto NO -->
                        <label for="diferencial-no" class="px-12 py-2 rounded-lg border cursor-pointer hover:text-white hover:bg-blue-600
                       peer-checked:bg-blue-600 peer-checked:text-white">
                            -
                        </label>
                    </div>
                    ...
                    <!-- Botón SÍ -->
                    <div>
                        <input type="radio" name="data[Plsesion][diferencial]" id="diferencial-si" value="1"
                            data-target="diferencial" data-show="true" class="hidden peer cursor-pointer"
                            <?php echo (isset($this->request->data['Plsesion']['diferencial']) && $this->request->data['Plsesion']['diferencial'] == '1') ? 'checked' : ''; ?> />
                        <label for="diferencial-si" class="px-12 py-2 rounded-lg border hover:bg-blue-600 cursor-pointer hover:text-white
                       peer-checked:bg-blue-600 peer-checked:text-white">
                            X
                        </label>
                    </div>
    ...
    <div class="bg-white shadow-2xl rounded-xl p-12">
        ...
        <div class="flex items-center mb-4">
            ...
            <div class="ml-4">
                ...
                <p class="text-gray-500">Marque con una X según corresponda. A dónde va dirigido el impacto: al agente
                    singular, a los colectivos y liderazgos o a las instituciones y sus trabajadores.</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="col-span-2 text-md font-semibold my-8 ">
                    <div class="flex justify-between ">
                        ...
                        <div class="flex space-x-4 items-center">
                            <!-- Botón NO -->
                            <div>
                                <input type="radio" name="data[Plsesion][obj_individuos]" id="obj_individuos-no"
                                    value="0" data-target="obj_individuos" data-show="false" class="hidden peer"
                                    <?php echo (isset($this->request->data['Plsesion']['obj_individuos']) && $this->request->data['Plsesion']['obj_individuos'] == 0) ? 'checked' : ''; ?> />
                                <label for="obj_individuos-no" class="px-12 py-2 rounded-lg border cursor-pointer hover:text-white hover:bg-blue-600
                       peer-checked:bg-blue-600 peer-checked:text-white">
                                    -
                                </label>
                            </div>
                            ...
                            <!-- Botón SÍ -->
                            <div>
                                <input type="radio" name="data[Plsesion][obj_individuos]" id="obj_individuos-si"
                                    value="1" data-target="obj_individuos" data-show="true"
                                    class="hidden peer cursor-pointer"
                                    <?php echo (isset($this->request->data['Plsesion']['obj_individuos']) && $this->request->data['Plsesion']['obj_individuos'] == 1) ? 'checked' : ''; ?> />
                                <label for="obj_individuos-si" class="px-12 py-2 rounded-lg border hover:bg-blue-600 cursor-pointer hover:text-white
                       peer-checked:bg-blue-600 peer-checked:text-white">
                                    X
                                </label>
                            </div>
                    ...
                    <p class="text-xs font-medium text-gray-400 text-align-center mt-6">Fortalecer la capacidad de
                        agencia en torno al bienestar individual y del entorno cercano, promoviendo procesos reflexivos,
                        basados en la autonomía, el afecto y la construcción del conocimiento en relación con la
                ...
                <div class="col-span-2 text-md font-semibold my-8 ">
                    <div class="flex justify-between">
                        ...
                        <div class="flex space-x-4 items-center">
                            <!-- Botón NO -->
                            <div>
                                <input type="radio" name="data[Plsesion][obj_organizaciones]" id="obj_organizaciones-no"
                                    value="0" data-target="obj_organizaciones" data-show="false" class="hidden peer"
                                    <?php echo (isset($this->request->data['Plsesion']['obj_organizaciones']) && $this->request->data['Plsesion']['obj_organizaciones'] == 0) ? 'checked' : ''; ?> />
                                <!-- 👈 Por defecto NO -->
                                <label for="obj_organizaciones-no" class="px-12 py-2 rounded-lg border cursor-pointer hover:text-white hover:bg-blue-600
                       peer-checked:bg-blue-600 peer-checked:text-white">
                                    -
                                </label>
                            </div>
                            ...
                            <!-- Botón SÍ -->
                            <div>
                                <input type="radio" name="data[Plsesion][obj_organizaciones]" id="obj_organizaciones-si"
                                    value="1" data-target="obj_organizaciones" data-show="true"
                                    class="hidden peer cursor-pointer"
                                    <?php echo (isset($this->request->data['Plsesion']['obj_organizaciones']) && $this->request->data['Plsesion']['obj_organizaciones'] == '1') ? 'checked' : ''; ?> />
                                <label for="obj_organizaciones-si" class="px-12 py-2 rounded-lg border hover:bg-blue-600 cursor-pointer hover:text-white
                       peer-checked:bg-blue-600 peer-checked:text-white">
                                    X
                                </label>
                            </div>
                    ...
                    <p class="text-xs font-medium text-gray-400 text-align-center mt-6">Fortalecer las organizaciones
                        sociales y los liderazgos propositivos a partir de la transformación de la cultura política en
                        relación con el derecho a la salud, incrementando su capacidad de agencia e incidencia colectiva
                ...
                <div class="col-span-2 text-md font-semibold my-8 ">
                    <div class="flex justify-between">
                        ...
                        <div class="flex space-x-4">
                            <!-- Botón NO -->
                            <div>
                                <input type="radio" name="data[Plsesion][obj_instituciones]" id="obj_instituciones-no"
                                    value="0" data-target="obj_instituciones" data-show="false" class="hidden peer"
                                    <?php echo (isset($this->request->data['Plsesion']['obj_instituciones']) && $this->request->data['Plsesion']['obj_instituciones'] == 0) ? 'checked' : ''; ?> />
                                <!-- 👈 Por defecto NO -->
                                <label for="obj_instituciones-no" class="px-12 py-2 rounded-lg border cursor-pointer hover:text-white hover:bg-blue-600
                       peer-checked:bg-blue-600 peer-checked:text-white">
                                    -
                                </label>
                            </div>
                            ...
                            <!-- Botón SÍ -->
                            <div>
                                <input type="radio" name="data[Plsesion][obj_instituciones]" id="obj_instituciones-si"
                                    value="1" data-target="obj_instituciones" data-show="true"
                                    class="hidden peer cursor-pointer"
                                    <?php echo (isset($this->request->data['Plsesion']['obj_instituciones']) && $this->request->data['Plsesion']['obj_instituciones'] == '1') ? 'checked' : ''; ?> />
                                <label for="obj_instituciones-si" class="px-12 py-2 rounded-lg border hover:bg-blue-600 cursor-pointer hover:text-white
                       peer-checked:bg-blue-600 peer-checked:text-white">
                                    X
                                </label>
                            </div>
                    ...
                    <p class="text-xs font-medium text-gray-400 text-align-center mt-6">Contribuir con el mejoramiento
                        de la capacidad de respuesta de las instituciones a las necesidades y demandas de la ciudadanía
                        en relación con el derecho a la salud, promoviendo la participación cualificada de los
                        diferentes actores sociales y fomentando la articulación intra e interinstitucional.</p>
                </div>
            </div>
            ...
            <div class="col-span-2 text-md font-semibold my-6">
                <div class="flex items-center mb-4">
                    <span class="mr-2 px-2 rounded-lg bg-green-200 text-md font-semibold">4</span>
                    <label for="objactividad" class="font-semibold">Objetivo general de la actividad pedagógica. El
                        objetivo debe ser medible y alcanzable</label>
                    <p class="text-red-600">*</p>
                </div>
                <?php
            ...
            <div class="col-span-2 text-md font-semibold my-6">
                <div class="flex items-center mb-4">
                    <span class="mr-2 px-2 rounded-lg bg-green-200 text-md font-semibold">5</span>
                    <label for="objactividad" class="font-semibold">Objetivos específicos. Los objetivos van de acuerdo
                        a los momentos metodológicos, concretan las intenciones educativas y contribuyen al logro del
                        objetivo de la actividad pedagógica.</label>
                    <p class="text-red-600">*</p>
                </div>
                <?php
    ...
    <div class="bg-white shadow-2xl rounded-xl p-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="col-span-2 text-md font-semibold my-6">
                <div class="flex items-center mb-4">
                    <span class="mr-2 px-2 rounded-lg bg-green-200 text-md font-semibold">5</span>
                    <label for="objactividad" class="font-semibold">Preguntas de sentido. La información propende por
                        generar conciencia, sujeto-tiempo-espacio, las preguntas construyen</label>
                    <p class="text-red-600">*</p>
                </div>
                <?php
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="col-span-2 text-md font-semibold my-6">
                ...
                <div class="relative w-full mt-4">
                    <?php if (!empty($this->request->data['Plsesion']['anexo'])): ?>
                    <div
                        class="block w-full text-sm text-gray-700 border border-gray-300 rounded-lg cursor-pointer bg-white focus:outline-none focus:ring-2 focus:ring-blue-400 p-3 file:mr-4 file:py-6 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                        Archivo actual:
                        <a href="<?php echo $this->webroot . 'files/plsesion/anexo/' . $this->request->data['Plsesion']['dirplanes'] . '/' . $this->request->data['Plsesion']['anexo']; ?>"
                            target="_blank" class="text-blue-600 underline ml-2">
                            <?php echo $this->request->data['Plsesion']['anexo']; ?>
                        </a>
                    </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="col-span-2 text-md font-semibold mb-6">
                ...
                <p class="text-gray-700 font-semibold text-sm mb-2">Por favor, proporcione el enlace a los insumos
                    propuestos para la sesión. recuerde que los enlaces deben ser accesibles y estar correctamente
                    formateados ademas de utilizar "," para separar. Estos son los dominios permitidos:
                    'drive.google.com',
                    'onedrive.com',
                    'youtube.com',
                    'github.com',
