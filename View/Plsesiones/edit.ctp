    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <fieldset>
                    <h2 class="page-header">Editar Plan de sesión</h2>
                    <?php
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            <?php echo $this->Form->input('momentosresumen', array('label' => 'Registre los aspectos relevantes de cada momento asi como palabras clave escriba despues de cada momento las papalbras claves y la idea principal', 'class' => 'ckeditor')); ?>
                        </div>
                        <div class="form-group col-md-12">
