...
<div class="flex max-w-6xl mx-auto text-center mb-8 gap-4">
    ...
    <button title="Ir a listado de eventos"
        class="flex items-center space-x-2 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700"
        onclick="window.location.href='<?php echo $this->Html->url(array('controller' => 'infoeventos', 'action' => 'index')); ?>'">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            class="lucide lucide-square-pen-icon lucide-square-pen">
    ...
    <button title="editar evento"
        class="flex items-center space-x-2 bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700"
        onclick="window.location.href='<?php echo $this->Html->url(array('action' => 'edit',  $infoevento['Infoevento']['id'])); ?>'">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            class="lucide lucide-square-pen-icon lucide-square-pen">
        ...
        <div class="overflow-x-auto">
            <table class="w-full border border-gray-300 text-sm text-gray-800">
                <tbody>
                    ...
                    <tr>
                        <td rowspan="4" class="p-2 text-center align-center">
                            <img src="<?php echo Router::url('/img/logo_pasto.png', true); ?>" alt="Logo Pasto"
                    ...
                    <tr>
                        <td colspan="8" class="border border-gray-300 font-semibold text-center p-2">
                            NOMBRE DEL FORMATO: REGISTRO DE INFORME O EVENTOS PIC
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="1" class="border border-gray-300 p-2 text-center">ID</td>
                        <td colspan="1" class="border border-gray-300 p-2">
                            <?php echo h($infoevento['Infoevento']['id']); ?>
                        </td>
                        <td colspan="1" class="border border-gray-300 p-2 text-center">Fecha</td>
                        <td colspan="1" class="border border-gray-300 p-2">
                            <?php echo h($infoevento['Infoevento']['fecha']); ?></td>
                        <td colspan="1" class="border border-gray-300 p-2">Responsable</td>
                        <td colspan="3" class="border border-gray-300 p-2 font-semibold">
                            <?php echo h($infoevento['Responsable']['nombres']); ?></td>

                    </tr>

                    <tr class="bg-gray-100">
                        <td colspan="1" class="border border-gray-300 font-semibold p-2 text-center">Ubicación</td>
                        <td colspan="3" class="border border-gray-300 p-2 ">
                            <?php echo h($infoevento['Ubicacion']['sitio']); ?></td>
                        <td colspan="3" class="border border-gray-300 p-2 ">
                            <?php echo h($infoevento['Infoevento']['lugar']); ?></td>
                        <td colspan="2" class="border border-gray-300 p-2 ">
                            <?php echo h($infoevento['Infoevento']['vereda']); ?></td>
                    </tr>


                    <tr>
                        <td colspan="1" class="border border-gray-300 font-semibold p-2 text-center">Tipo</td>
                        <td colspan="4" class="border border-gray-300 p-2 uppercase">
                            <?php echo h($infoevento['Infoevento']['tipo']); ?></td>
                        <td colspan="1" class="border border-gray-300 font-semibold p-2 text-center">Temática</td>
                        <td colspan="3" class="border border-gray-300 p-2">
                            <?php echo h($infoevento['Producto']['nombredim']); ?></td>
                    </tr>
                    <tr>
                        <td colspan="1" class="border border-gray-300 font-semibold p-2">Tema</td>
                        <td colspan="4" class="border border-gray-300 p-2 font-semibold">
                            <?php echo h($infoevento['Infoevento']['tema']); ?></td>
                        <td colspan="1" class="border border-gray-300 font-semibold p-2">Entorno</td>
                        <td colspan="3" class="border border-gray-300 p-2">
                            <?php echo h($infoevento['Producto']['entorno']); ?></td>
                    </tr>
                    ...
                    <tr class="bg-gray-100">
                        ...
                        <td colspan="8" class="border border-gray-300 p-2">
                            <?php echo $this->Html->link($infoevento['Producto']['producto'], array('controller' => 'productos', 'action' => 'view', $infoevento['Producto']['id'])); ?>
                        </td>
                    </tr>
                    ...
                    <tr class="bg-gray-100">
                        ...
                        <td colspan="8" class="border border-gray-300 p-2">
                            ...
                            <?php
								$auxDsr = strrpos(($infoevento['Infoevento']['observacion']), '/');
								if ($auxDsr === false) {
								?>
                            <textarea class="ckeditor"
                                readonly><?php echo ($infoevento['Infoevento']['observacion']); ?></textarea>
                            <?php                                                                                                                     } else {
								print($infoevento['Infoevento']['observacion']);
                            }
                           ?>
                        </td>
                    ...
                    <tr>
                        <td class="border border-gray-300 font-semibold p-2 text-center">Anexo:</td>
                        <td colspan="8" class="border border-gray-300 p-2 text-blue-600">
                            <?php
							if (!empty($infoevento['Infoevento']['anexo'])) {
								echo $this->Html->link(
									h($infoevento['Infoevento']['anexo']),
									'../files/infoevento/anexo/' . $infoevento['Infoevento']['informe_dir'] . '/' . $infoevento['Infoevento']['anexo'],
									['target' => '_blank', 'class' => 'underline text-blue-700 hover:text-blue-900']
								);
							} else {
								echo '<span class="text-gray-400 italic">Sin anexo</span>';
							}
							?>
                        </td>
                    </tr>
...
window.addEventListener("beforeunload", function() {
    ...
    fetch("<?php echo $this->Html->url(['controller' => 'infoeventos', 'action' => 'index']); ?>", {
        method: "POST",
        keepalive: true
    });
});
