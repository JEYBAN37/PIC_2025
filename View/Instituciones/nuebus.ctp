...
<div class="usuarios index">
    <?php
    echo $this->Form->create("Institucion", array("action" => "nuebus"));
//    echo $this->Form->input("Busqueda", array("Label" => "Institución a buscar"));
    ...
    <table cellpadding="0" cellspacing="0" id="list" class="table table-bordered table-hover">
        <tr>
            ...
            if (empty($l)) {
                ...
                foreach ($l[0]["Institucion"] as $i => $v) {
                    echo "<th>" . $i . "</th>";
                }
            }
            echo "<th>Editar</th>";
        ...
        <div class="actions">
            ...
            foreach ($l as $i => $v) {
                echo "<tr>";
                foreach ($v["Institucion"] as $j => $w) {
                    echo "<td>" . $w . "</td>";
                }
                echo "<td>" . $this->Html->link("Ver", "view/" . $v["Institucion"]["id"], array('target' => '_blank')) . "</td>";
                echo "<td>" . $this->Html->link("Editar ", "edit/" . $v["Institucion"]["id"]) . "</td>";
                echo "</tr>";
            }
            ?>
        </div>
...
//		echo $this->Paginator->next(__('proximo') . ' >', array(), null, array('class' => 'next disabled'));
    ...
    <!--    <div class="actions">
            <ul>
                <li>
    <?php
//                echo $this->Html->link(__('Actualizar'), array('controller' => 'actividades', 'action' => 'nuebus')); 
    ?> 
                </li>			
            </ul>
        </div>-->
