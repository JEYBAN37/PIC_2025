...
<?php echo $this->Form->create('Participante'); ?>
	<fieldset>
		<legend><?php echo __('Participantes a encuentros educativos'); ?></legend>
	<?php
		...
		echo $this->Form->input('sector',array('label'=>'Zona de ubicacion',
            'options' => array('urbano' => 'Urbano', 'rural' => 'Rural', 'sd' => 'SD', 'ni' => 'NI')));
