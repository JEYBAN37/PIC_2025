...
<?php echo $this->Form->create('SistematizacionProcesosViewTest'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sistematizacion Procesos View Test'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SistematizacionProcesosViewTest.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('SistematizacionProcesosViewTest.id'))); ?></li>
