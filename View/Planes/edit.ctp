...
<?php echo $this->Html->script('ckeditor/ckeditor'); ?>
 ...
 <?php echo $this->Form->create('Plan'); ?>
	<fieldset>
		<legend><?php echo __('Editar Plan de sesión'); ?></legend>
	   ...
	   <div class="form-group col-md-4">
		...
		<?php echo $this->Form->input('cuerpoterritorio', array('label'=>'Cuerpo territorio', 'options' => array('' => 'Elegir', ' ' => '-', '1' => 'X'), 'class' => 'form-control'));?>
	 ...
	 <div class="form-group col-md-4">
			...
			<?php echo $this->Form->input('metodologia',array('label'  => 'Metodología utilizada', 'class' => 'ckeditor'));?>
			     ...
			     <div class="form-group col-md-12">
			<?php echo $this->Form->input('resultado0',array('label'=>'Resultado primer momento','class'=>'ckeditor'));?>
			...
			<?php echo $this->Form->input('metodologiauno',array('label'  => 'Metodología utilizada', 'class' => 'ckeditor'));?>
			    ...
			    <div class="form-group col-md-12">
			<?php echo $this->Form->input('resultadouno',array('label'=>'Resultado segundo momento','class'=>'ckeditor'));?>
			...
			<?php echo $this->Form->input('metodologiados',array('label'  => 'Metodología utilizada', 'class' => 'ckeditor'));?>
			    ...
			    <div class="form-group col-md-12">
			<?php echo $this->Form->input('resultadodos',array('label'=>'Resultado tercer momento','class'=>'ckeditor'));?>
			...
			<?php echo $this->Form->input('metodologiatres',array('label'  => 'Metodología utilizada', 'class' => 'ckeditor'));?>
			     ...
			     <div class="form-group col-md-12">
			<?php echo $this->Form->input('resultadotres',array('label'=>'Resultado cuarto momento','class'=>'ckeditor'));?>
