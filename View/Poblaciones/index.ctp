...
<div class="poblaciones index">
	...
	<tr>
		<td><?php echo h($poblacion['Poblacion']['id']); ?>&nbsp;</td>
		<td><?php echo h($poblacion['Poblacion']['poblacion']); ?>&nbsp;</td>
		<td><?php echo h($poblacion['Poblacion']['caracteristica']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $poblacion['Poblacion']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $poblacion['Poblacion']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $poblacion['Poblacion']['id']), array(), __('Are you sure you want to delete # %s?', $poblacion['Poblacion']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Nueva Poblacion'), array('action' => 'add')); ?></li>
