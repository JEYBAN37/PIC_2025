        ...
        <div class="container">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li><a href="../plsesiones/add">Nuevo plan</a></li>
              <li><a href="../planes/nuebus">Ver planes 2014-2017</a></li>
              <li><a href="https://ciudadbienestar.freshdesk.com/support/home" target="_blank">Mesa de Ayuda</a></li>
              <!--li>
                <?php
                if ($auxDsr === false) { 
                  echo '<a href=""> <img src="../img/boton-actualizar.png " alt="Refrescar consulta" >Refrescar consulta</a>';
                } else {
                  echo '<a href="../nuebus"> <img src="../../img/boton-actualizar.png " alt="Refrescar consulta" >Refrescar consulta</a>';
                }              
                ?>                
              </li!-->
              <li> 
