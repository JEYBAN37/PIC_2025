...
class Persona extends AppModel {
	...
	public $validate = array(
		...
		'preferencia' => array(
			'notEmpty' => array(
				'rule' => array('notEmpty'),
				'message' => 'Seleccione una opci贸n de la lista',
				//'allowEmpty' => false,
				//'required' => false,
				//'last' => false, // Stop validation after this rule
				//'on' => 'create', // Limit validation to 'create' or 'update' operations
 ...
 */
	public $hasMany = array(
		...
		'Personasactividad' => array(
			'className' => 'Personasactividad',
			'foreignKey' => 'persona_id',
			'dependent' => false,
			'conditions' => '',
			'fields' => '',
